...
def daily_batch_schema():
    ...
    data_schema = StructType([
        StructField("Meta Data", meta_data_schema, True),
        StructField("Time Series (Daily)", MapType(StringType(), time_series_schema), True)
    ])
...
def monthly_batch_schema():
    ...
    data_schema = StructType([
        StructField("Meta Data", meta_data_schema, True),
        StructField("Monthly Time Series", MapType(StringType(), time_series_schema), True)
    ])
